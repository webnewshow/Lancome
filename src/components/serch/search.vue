<template>
    <div class="Skin-Search">
        ...
        <div class="mabey" >
            <span v-show="$store.state.search.serchlist.length === 0">你可能会喜欢</span>
            <ul class="search-result-con search-like clearfix margin-t-30 clearfix"  v-show="$store.state.search.serchlist.length === 0">
                <div class="margin-tb-50">
                    <li class="search-list fl padding-lr-10 text-c" v-for="(item,index) in likeData" :key="index" >
                        ...
                        <div>
                            ...
                            <p class="font-18 " >{{item.g_title}}</p>
                            <p class="font-18 padding-tb-20 bottom" >{{item.g_enTitle}}</p>
                            <div class="clearfix padding-tb-10" style="position:relative;">
                                <p class="fl" style="width:60%;">
                                    <img style="height:20px;width:70%;" src="./img/3.png"/>
                                </p>
                                <p class="fl padding-l-10  " style=" border-left:1px solid #ccc;font-weight: bolder;width: 20%;">
                                    <span>¥{{item.g_price}}</span>
                                </p>
                            </div>
                        </div>
