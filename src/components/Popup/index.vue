    ...
    <div class="skin-wrap on">
        <div class="skin-inner">
            ...
            <div class='skin-product-right'>
                <div class='skin-title-Enname'>L'Absolu Rouge Ruby Cream</div>
                <div class='skin-title-Cnname'>菁纯宝石唇膏</div>
                ...
                <div class='clearfix margin-tb-20'>
                    <span class='fl'><a class='font-14' @click="getGoodsMessges">添加到我的收藏夹</a></span><span class='fr'><a class='font-14'>点击查看产品详情<i class='el-icon-arrow-right'></i></a></span>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        mouseMove (e) {
            ...
            let endTop = -((imgMaxHeight / imgMinHeight) * mouseSkinTop / 2) + scrollTop
        ...
        getGoodsMessges () {
            ...
            axios({
                method: 'get',
                url: 'http://192.168.97.254:3001/getdeatail',
                params: {
                    id: id
                }
            }).then(res => {
