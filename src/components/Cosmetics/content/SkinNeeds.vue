  ...
  <div class="clearfix skin-content-lists">
    ...
    <div class="skin-cen-fl">
      ...
      <div class="skin-text-l">
        <div class="skin-f-f">
            <p class="skin-f-fu">肌肤需求</p>
        </div>
           <!-- 第二模块 三大类 -->
         <div class="skin-f-th">
            <p class="skin-f-fh">卸妆清 </p>
        </div>
        <div class="skin-f-th">
            <p class="skin-f-fh">舒缓保湿</p>
        </div>
        <div class="skin-f-th">
            <p class="skin-f-fh">精华修护</p>
        </div>
        <div class="skin-f-th">
            <p class="skin-f-fh">美白淡斑</p>
        </div>
        <div class="skin-f-th">
            <p class="skin-f-fh">紧致提拉</p>
        </div>
        <div class="skin-f-th">
            <p class="skin-f-fh">抗老愈颜</p>
        </div>
