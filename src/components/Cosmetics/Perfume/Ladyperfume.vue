    ...
    <div class="skin-cen-fl">
      ...
      <div class="skin-text-l">
        ...
        <div class="skin-f-f">
           ...
           <!-- 第二模块 三大类 -->
         <div class="skin-f-th">
            <p class="skin-f-fh">女士香水</p>
        </div>
        <div class="skin-f-th">
            <p class="skin-f-fh">美丽人生系列</p>
        </div> <div class="skin-f-th">
            <p class="skin-f-fh">奇迹系列</p>
        </div> <div class="skin-f-th">
            <p class="skin-f-fh">珍爱系列</p>
        </div> <div class="skin-f-th">
            <p class="skin-f-fh">殿堂系列</p>
        </div>
        <div class="skin-element skin-el-deep">
          </div>
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item class="skin-s-x" title="价格筛选" name="1">
          <!-- <p>卸妆乳</p> -->
